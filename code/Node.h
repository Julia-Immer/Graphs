...
public:
  ...
  // Have you ever wondered when you say cout << "hello world!" << endl; what << means? how is it implemented?
  // these are operator methods that you can define for your classes. Bellow is an example on how you can define << operator 
  ...
  // you can define similar operators like +,-,* for you classes and define what it means to sum two of this class's objects.
